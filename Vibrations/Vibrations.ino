...
unsigned long myChannelNumber = 988599;
const char * myWriteAPIKey = "EZNNY0XA1TPDOG5D";

#include <ESP8266WiFi.h>

char ssid[] = "GrifW1";   // your network SSID (name)
char pass[] = "kb,J5jQdFH(]8" = SECRET_SSID;   // your network password
